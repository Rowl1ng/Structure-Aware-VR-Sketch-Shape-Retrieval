...
def get_deformer(model_name):
    ...
    path = '/vol/research/sketching/projects/VR_Sketch_lightning/project/logs/experiments/{}/.hydra/config.yaml'.format(model_name)
    cfg = omegaconf.OmegaConf.load(path)
    checkpoint_file = '/vol/research/sketching/projects/VR_Sketch_lightning/project/logs/experiments/{}/checkpoints/last.ckpt'.format(model_name)
